...
public interface H2HConstants {
	...
	static final BigInteger GIGABYTES = BigInteger.valueOf(1024 * 1024 * 1024);
	static final BigInteger MEGABYTES = BigInteger.valueOf(1024 * 1024);
	public static final BigInteger DEFAULT_MAX_FILE_SIZE = BigInteger.valueOf(2).multiply(GIGABYTES);// 25 MB
